...
#import "fvFitnessLogViewController.h"
#import "fvViewController.h"
#import "DBManager.h"
#import "fvLogCell.h"

@interface fvFitnessLogViewController ()

@end

@implementation fvFitnessLogViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *fitnessText = [NSString stringWithFormat:@"%@ %@ %@", [object objectAtIndex:1], [object objectAtIndex:2], [object objectAtIndex:3]];
    [[cell textLabel] setText:fitnessText];
    return cell;
}
